    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 px-6 max-w-md mx-auto w-full pt-4">
        ...
        <form onSubmit={handleSignup} className="space-y-6">
            ...
            <button 
                type="submit"
                disabled={!email || !username || !password || !birthday.year}
                className="w-full bg-primary hover:bg-primary-dark disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 rounded-lg shadow-sm transition-all active:scale-[0.98] text-lg mt-4"
            >
                注册
            </button>
        </form>
