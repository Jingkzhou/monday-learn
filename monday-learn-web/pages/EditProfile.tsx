...
export const EditProfile: React.FC = () => {
    ...
    if (loading) {
        return (
            <div className="pt-20 px-4 md:px-8 md:ml-64 pb-10 min-h-screen bg-bg-gray flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-6">
                                ...
                                <div className="relative group">
                                    <div className="w-24 h-24 rounded-full bg-purple-100 border-4 border-white shadow-md overflow-hidden flex items-center justify-center text-3xl">
                                        {avatarUrl ? (
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    <button
                                        ...
                                        className={`w-12 h-12 rounded-full border-2 border-dashed border-gray-300 flex items-center justify-center text-gray-400 hover:border-gray-400 hover:text-gray-600 transition-all ${!avatarUrl ? 'border-primary text-primary bg-primary/5' : ''
                                            }`}
                                        title="使用文字头像"
                                    >
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all font-medium"
                                    placeholder="输入用户名"
                                />
